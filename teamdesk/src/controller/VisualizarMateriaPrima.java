...
public class VisualizarMateriaPrima implements Initializable {
    ...
    /**
     * Defines the column's cell values and populates table
     */
    public void loadTableView() {
        ...
        observableListProduct = FXCollections.observableArrayList(n);
    ...
    public void alterar(ActionEvent actionEvent) throws IOException, SQLException {
            ...
            boolean btnInsertClicked = controlletUpdateRawMaterial(product);
            if (btnInsertClicked) {
                if (!DatabaseProduct.updateProducts(product)) {
                    Helper.showAlert(Alert.AlertType.ERROR, "Alterar","Alterar matéria prima",
                            "Erro ao alterar matéria prima!");
                } else {
                    Helper.showAlert(Alert.AlertType.INFORMATION, "Alterar","Alterar matéria prima",
                            "Matéria prima alterada com sucesso!");
                    loadTableView();
    ...
    /**
     * Opens Update Raw Material scene
     * @param product
     * @return
     * @throws IOException
     */
    public static boolean controlletUpdateRawMaterial(Product product) throws IOException {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(UpdateRawMaterialController.class.getResource("/view/updateRawMaterial.fxml"));
        ...
        UpdateRawMaterialController controller = loader.getController();
